...
def IBDD(train_data, test_data, window_length, consecutive_values):
...
def IKS(train_data, test_data, window_length, ca):
...
def WRS(train_data, test_data, window_length, threshold):
...
def Adwin(train_data, test_data, window_length):
